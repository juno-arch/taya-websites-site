...
## The three tiers (sample numbers — set the real ones)

| Plan | Build | Monthly | What it covers |
|---|---|---|---|
...
Push this folder to a new GitHub repo, then
**Settings → Pages → Source: Deploy from a branch → main / (root) → Save**.
(Note: the saved GitHub token was expired as of Sept 2026 — needs refreshing first.)
